        ...
        <div className="flex flex-col mx-4 gap-4">
            <div className="flex flex-col items-center gap-5">
                ...
                <div className="flex items-center gap-1 border-2 border-black rounded-full mb-3 w-auto px-2">
                    <Buttons style='font-bold text-[11px] py-3 px-1' name="Start With Us"/>
            ...
            <div className="bg-lime-950 text-white flex flex-col items-center h-64 w-full">
                <div className="text-[16px] mx-8 my-6">Our approch</div>
                <div className=" mx-8 text-center">Lorem ipsum dolor sit, amet consectetur 
